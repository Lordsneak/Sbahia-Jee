...
<body>
   ...
   <div class="container">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse flex-grow-1 text-right" id="myNavbar">
                        <ul class="navbar-nav ml-auto flex-nowrap">
                            ...
                            <li class="nav-item">
                                <a href="/SBahia/register.jsp" class="nav-link m-2 menu-item">Inscription</a>
                            </li>
                            <li class="nav-item">
                                <a href="/SBahia/login.jsp" class="nav-link m-2 menu-item">Login</a>
                            </li>
                        </ul>
                    </div>
                </nav>
                ...
                <section class="container-fluid">
                    <section class="row justify-content-center">
                      <section class="col-md-10 col-xl-5 col-lg-6 col-sm-10 mx-auto text-center form">
                        <form class="form-container" action="/SBahia/login" method="post">
                          <div class="form-group">

                            <p>Welcome to SBahia</p>
        ...
        <td><span style="color:red"><%=(request.getAttribute("errMessage") == null) ? "" : request.getAttribute("errMessage")%></span></td>
                          ...
                          <hr>
                          <div class="form-group">
                          <a href="/SBahia/register.jsp">New to SBahia ? Create Account</a>
                          </div>
