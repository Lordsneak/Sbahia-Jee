                ...
                <section class="container-fluid">
                    <section class="row justify-content-center">
                      <section class="col-md-10 col-xl-5 col-lg-6 col-sm-10 mx-auto text-center form">
                        <form class="form-container" action="/SBahia/editproduct?id=<%= request.getParameter("id") %>" method="post">
                          ...
                          <button type="submit" name="login" class="btn btn-primary btn-block">Edit Product</button>
                        </form>
                      </section>
                    </section>
                  </section>
